    ...
    <div className="relative h-screen w-full">
      ...
      <div className="relative z-10 flex items-center justify-center h-full">
        ...
        <div className="w-full flex justify-center items-center mr-5">
          <div
            className="w-105 h-101 flex flex-col items-center border-gray bg-white p-4 rounded-[24px]"
          ...
          >
            ...
            <Link href="/signup" className="self-end px-0 mt-2">
              <Button variant="link" className="self-end px-0 mt-2">
                회원가입
              </Button>
            </Link>
            <Button variant="default" className="w-full h-12 mt-2 mx-auto">
              로그인
            </Button>
          </div>
        </div>
